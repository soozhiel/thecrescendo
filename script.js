const SITE_URL = 'https://thecrescendo.vercel.app';
...
async function sharePage() {
  if (navigator.share) { try { await navigator.share({ title: 'The Crescendo — Sonic Remedy | Soozhee', text: 'The Crescendo by Soozhee. Sonic Remedy : Audiosensory Resonance | No Regret.', url: SITE_URL }); return; } catch (e) {} }
